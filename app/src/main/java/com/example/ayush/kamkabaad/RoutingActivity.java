...
public class RoutingActivity extends AppCompatActivity implements OnMapReadyCallback,
                ...
                .subscribe(new DisposableSingleObserver<ReverseGeocoderSearchResponse>() {
                    ...
                    private void processResponse(ReverseGeocoderSearchResponse response) {
                        if (response.hasResults()) {
                            ...
                            Toast.makeText(RoutingActivity.this, getString(R.string.geocode_no_results), Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void initUIView() {
        departureIcon = Icon.Factory.fromResources(RoutingActivity.this, R.drawable.ic_map_route_departure);
        destinationIcon = Icon.Factory.fromResources(RoutingActivity.this, R.drawable.ic_map_route_destination);
    ...
    private void setUIViewListeners() {
        ...
        btnHelp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // TODO : intent to different class which gives help on how to use
...
//                startActivity(intent);
                        ...
                        .subscribe(new DisposableSingleObserver<AlongRouteSearchResponse>() {
                            ...
                            private void displaySearchResults(List<AlongRouteSearchResult> results) {
                                if (!results.isEmpty()) {
                                    ...
                                    Toast.makeText(RoutingActivity.this, String.format(getString(R.string.no_search_results), textToSearch), Toast.LENGTH_LONG).show();
                                }
                            }
    ...
    private void handleApiError(Throwable e) {
        dismissDialogInProgress();
        Toast.makeText(RoutingActivity.this, getString(R.string.api_response_error, e.getLocalizedMessage()), Toast.LENGTH_LONG).show();
    }
    ...
    private RouteQuery createRouteQuery(LatLng start, LatLng stop, LatLng[] wayPoints) {
        return (wayPoints != null) ?
                ...
                new RouteQueryBuilder(start, stop).withRouteType(RouteType.SHORTEST);
    }
